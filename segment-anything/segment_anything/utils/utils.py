...
def collate_fn(batch):
    images, masks, point_prompts, point_labels, box_prompts, task_prompts, origin_masks = zip(*batch)
    ...
    return images, masks, point_prompts, point_labels, box_prompts, task_prompts, origin_masks
